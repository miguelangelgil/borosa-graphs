"""
Descargador de datos de PIB del FMI DataMapper
Indicador: NGDPD (GDP, current prices, USD billions)
"""
...
def fetch_gdp_data():
    print("Descargando datos de PIB del FMI...")
    print(f"URL: {IMF_URL}\n")
...
def main():
    try:
        ...
        print(f"\nTop 10 países por PIB ({latest_year}):")
